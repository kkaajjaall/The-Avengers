...
const char5 = () => {
    return (
        <>
            <div class="char2">
              <img  className="char-pic"src="./images/c5.jpg"/>
              <div class="info">
              <h1> Mark Ruffalo</h1>
              <p>  Actor | Producer </p>
              <h3> as Bruce Banner</h3>
              <p> <strong> Born:</strong> 	November 22, 1967 in Kenosha, Wisconsin, USA</p>
               <p>  <strong> Birth Name:</strong>  	Mark Alan Ruffalo</p>
                 
                 <p> <strong> Height: </strong> 	5' 8½" (1.74 m)</p>
                 </div>
                 </div> 
                 <div class="pass">
                     <p> Award-winning actor Mark Ruffalo was born on November 22, 1967, in Kenosha, Wisconsin, of humble means to father Frank Lawrence Ruffalo, a construction painter and Marie Rose (Hebert), a stylist and hairdresser; his father's ancestry is Italian and his mother is of half French-Canadian and half Italian descent. Mark moved with his family to Virginia Beach, Virginia, where he lived out most of his teenage years. Following high school, Mark moved with his family to San Diego and soon migrated north, eventually settling in Los Angeles.</p>
                     <p> Mark first took classes at the Stella Adler Conservatory and subsequently co-founded the Orpheus Theatre Company, an Equity-Waiver establishment, where he worked in nearly every capacity. From acting, writing, directing and producing to running the lights and building sets while building his resume.
